...
// ): void => {
// 	firebaseLogEvent<AnalyticsEventName>(firebaseAnalytics, eventName, eventParams);
// };
...
// const logEndGame = ({ win, difficulty, startedAt }: LogEndGameParams & { win: boolean }): void => {
// 	const endedAt = now();
